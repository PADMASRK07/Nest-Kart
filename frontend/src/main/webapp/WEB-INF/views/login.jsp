	...
	<form>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-2"></div>
				<div class="col-2">
					<label><a class="a">Email id</a></label>
				</div>
				<div class="col-4">
					<div class="input-group">
						...
						<input type="text" class="form-control"
							placeholder="padmasrk07@gmail.com" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			<DIV CLASS="ROW">
				<div class="col-4"></DIV>
				<div class="col-5">
					<span style="color: #1C4F73"> Forget Password ? / </span> <span
						style="color: #1C4F73"> New to page ?<a href="register">
							Register </a></span>
				</DIV>
				<div class="col-3"></DIV>
			</div>
