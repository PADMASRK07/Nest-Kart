...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			<c:if test="${editmode}">
				<c:url var="myurl" value="updatecategory"></c:url>
			</c:if>
			<c:if test="${! editmode}">
				<c:url var="myurl" value="category"></c:url>
			</c:if>
			<form:form action="${myurl}" method="post" modelAttribute="category">
				<c:if test="${editmode}">
					<div class="form-group">
						<div class="row">
							<div class="col-5">
								<label style="font-size: 20px">Category Id</label>
							</div>
							<div class="col-7">
					...
					<div class="row">
						...
						<div class="col-7">
							<div class="input-group">
								...
								<form:input type="text" class="form-control"
									placeholder="Enter Category Name" path="cat_name" />
							</div>
						</div>
						<div class="col-5"></div>
						<div class="col-7">
							<form:errors path="cat_name" cssClass="errinfo"></form:errors>
						</div>
					</div>
				</div>
				<br>
	...
	<div class="row">
		<div class="col-12">
			...
			<c:if test="${empty catlist}">
				<div class="jumbotron">
					<strong>No Category Available Add Category Now</strong>
				</div>
			</c:if>
			<br>
			<c:if test="${not empty catlist}">
				<c:forEach items="${catlist}" var="c">
					<div class="border-card">
						<div class="card-type-icon with-border">${c.cat_id}</div>
						<div class="content-wrapper">
							<div class="label-group fixed col-4">
								<p class="title">${c.cat_name}</p>
							</div>
							<div class="col-2"></div>
							<div class="label-group col-2">
								<p class="title">
									<a href="editcategory?catid=${c.cat_id}" class="btn btn-success"><i
							...
							<div class="label-group col-2">
								<p class="title">
									<a class="btn btn-danger"
										href="deletecategory?catid=${c.cat_id}"><i
